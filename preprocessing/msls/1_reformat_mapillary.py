...
default_cities = {
    ...
    'train': ['amsterdam', 'manila'],
    'val': [],
}
root = '/home/ps/225nas/Mapillary/Mapillary_Street_Level_Sequences' # insert here folder of mapillary dataset to format
base_dst_folder = 'msls_reformat' # insert here destination path of formatted dataset
...
for csv_file_path in csv_files_paths:
    ...
    if (city not in default_cities["train"]) and (city not in default_cities["val"]):
        continue
