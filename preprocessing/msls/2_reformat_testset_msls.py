...
def get_city_seqs(split, subset, city):
    ...
    base_path = pjoin(SR_PATH, split, subset)
...
def move_seqs(src_split, dst_split, subset, sequences):
    ...
    base_src = pjoin(SR_PATH, src_split, subset)
...
# moves = {
#     ('train', 'train'): ['melbourne'],
#     ('train', 'val'): ['austin'],
#     ('val', 'test'): ['cph', 'sf'],
#     ('train','test'): ['boston','amman']
# }
...
SR_PATH = 'msls_reformat'
DS_PATH = 'msls_reformat'
