...
init_script()
import argparse
from svpr.datasets.cache_db import cache_mapillary_train, retrieve_db_object
import re

parser = argparse.ArgumentParser(description="cache train dataset object")
parser.add_argument('--seq', type=int, default=5)
parser.add_argument("--dataset_path", type=str, default='msls_reformat', help="Path of the dataset")
parser.add_argument('--save_to', type=str, default='cache/crop/modifydataset2/', help='path to save the object')
...
cache_mapillary_train(args.dataset_path,
                      f'{folder}/reformat_msls{f_cities}_train_{seq_len}seq_{nNeg}neg_10_25.pkl',
                      split='train',
                      posDistThr=10,
                      negDistThr=25,
                      nNeg=nNeg,
